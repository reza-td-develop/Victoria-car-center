...
// import { useDispatch, useTexture } from 'react-redux'
...
const newDena = (props) => {
  ...
  const { nodes, materials } = useGLTF('./models/dena-shop.gltf');
  const changeWhite = ConfiguratorSlice.actions.changeWhite;
  const changeBlack = ConfiguratorSlice.actions.changeBlack;
  const dispatch = useDispatch();
  const rimComPic = rimPic;

  const setting = useTexture({
    map: setTireMap,
    normalMap: setTireNormalMap,
    roughnessMap: setTireRoughnessMap,
    aoMap: setTireAoMap
  })

  setting.map.repeat.set(7, 7);
  setting.normalMap.repeat.set(7, 7);
  setting.roughnessMap.repeat.set(7, 7);
  setting.aoMap.repeat.set(7, 7);


  setting.map.wrapS = setting.map.wrapT =
    setting.normalMap.wrapS = setting.normalMap.wrapT =
    setting.roughnessMap.wrapS = setting.roughnessMap.wrapT =
    setting.aoMap.wrapS = setting.aoMap.wrapT =
    THREE.RepeatWrapping;


  const rimText = useTexture({
    map: rimComPic,
    normalMap: rimComPic,
    roughnessMap: rimComPic,
    aoMap: rimComPic
  })

  console.log(setTireNormalMap);
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.rimBotLeft6.geometry} material={materials['14___3Default']} position={[0.79, 0.34, -1.35]} rotation={[1.29, -0.01, -3.12]} scale={0} />
      ...
      <mesh geometry={nodes.rimUpLeft5001.geometry} material={materials['aluminium.001']} position={[0.83, 0.33, 1.3]} rotation={[1.58, -0.01, -1.55]} scale={0.01} />
      ...
      <mesh geometry={nodes.rimBotRight6.geometry} material={materials['14___3Default.004']} position={[-0.78, 0.33, -1.35]} rotation={[1.85, 0, 0.01]} scale={0} />
      ...
      <mesh geometry={nodes.rimBotRight5.geometry} material={materials['aluminium.002']} position={[-0.82, 0.33, -1.35]} rotation={[1.6, 0.01, 1.58]} scale={0.01} />
      <mesh geometry={nodes.rimUpLeft6002.geometry} material={materials['14___3Default.008']} position={[0.79, 0.34, 1.3]} rotation={[1.29, -0.01, -3.12]} scale={0} />
      ...
      <mesh geometry={nodes.rimUpRight5001.geometry} material={materials['aluminium.003']} position={[-0.82, 0.33, 1.3]} rotation={[1.6, 0.01, 1.58]} scale={0.01} />
      <mesh geometry={nodes.rimUpRight6001.geometry} material={materials['14___3Default.012']} position={[-0.78, 0.34, 1.3]} rotation={[1.85, 0, 0]} scale={0} />
    </group>
  )
}

useGLTF.preload('../../public/models/newDena.gltf')

export default newDena;